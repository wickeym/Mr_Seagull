...
export class ChaosMissionScene extends Phaser.Scene {
  ...
  public create(): void {
    ...
    this.hudChaos = this.add.text(16, 60, '', this.hudStyle()).setDepth(70);
    this.hudObjectives = this.add.text(16, 84, '', this.hudStyle()).setDepth(70);
    this.hudWind = this.add.text(16, 108, '', this.hudStyle()).setDepth(70);
    this.hudDrop = this.add.text(16, 132, '', this.hudStyle()).setDepth(70);
  ...
  public update(_: number, deltaMs: number): void {
    ...
    this.missionSystem.update(deltaSec);
  ...
  private resolveImpact(impact: PoopImpact): void {
    ...
    this.missionSystem.registerHit(target instanceof Human ? 'human' : 'car', target.chaosValue);
